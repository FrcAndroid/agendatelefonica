                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{$agenda->nombres}}" class="form-control" id="nombres" name="nombres" placeholder="Nombres" required="" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{$agenda->apellidos}}" class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos" required="" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input value="{{$agenda->telefono}}" class="form-control" type="number" name="telefono" placeholder="Telefono: 18491115555" id="telefono" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input  value="{{$agenda->movil}}" class="form-control" type="number" name="celular" placeholder="Celular: 18491115555" id="Celular" disabled>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input  value="{{$agenda->email}}" type="email" name="email" class="form-control" placeholder="Email"  disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input  value="{{$agenda->posicion}}" type="text" name="posicion" class="form-control" placeholder="Posición" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input  disabled value="{{$agenda->salario}}" type="number" class="form-control" name="salario" placeholder="salario *" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input disabled  value="{{$agenda->fechadenacimiento}}" type="date" name="fechadenacimiento" id="fechadenacimiento" min="1000-01-01"
                                    ...
                                    <a href="{{route('agenda.edit', $agenda->id)}}" class="redondo btn btn-success btncolorblanco"><i class="fa fa-edit"></i> Editar</button>
